...
$sql = "SELECT tb_ocupacao.id, tb_vaga.id as vaga, situacao, setor, numero, nome, placa, cor, hora_entrada, hora_saida, valor FROM tb_ocupacao JOIN tb_veiculo ON tb_ocupacao.id_veiculo = tb_veiculo.id JOIN tb_vaga ON tb_ocupacao.id_vaga = tb_vaga.id JOIN tb_cliente ON tb_veiculo.id_usuario = tb_cliente.id;";
